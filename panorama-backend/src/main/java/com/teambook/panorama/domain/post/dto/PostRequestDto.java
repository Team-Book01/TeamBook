 ...
 */
public record PostRequestDto (@NotNull PostCategory category, @NotBlank @Size(max = 255) String title, @NotBlank String content, List<String> imageKeys, String isbn, String bookTitle, String bookAuthor, String bookImageUrl) {
