...
public record PostSummaryResponseDto(Long postId, Long bookId, String nickname, PostCategory category, String title, String contentPreview, int viewCount, LocalDateTime createdAt, String bookTitle, String author) {
